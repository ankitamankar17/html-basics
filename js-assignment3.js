...
console.log("hello");
// var currentProducts = productList[counter];
...
for (var counter = 0; counter <= productList.length; counter++) {
  ...
  if (currentProducts.isAccessory) {
    card.appendChild(cloth);
    console.log(ass);

  } else {
    cloth.appendChild(ass);
    console.log(cloth);
  ...
  img.src = currentProducts.photos;
  var h3 = document.createElement('h3');
  h3.innerText = currentProducts.name;
  var h4 = document.createElement('h4');
  h4.innerText = currentProducts.brand;
  var h5 = document.createElement('h5');

  h5.innerText = currentProducts.price;
